...
describe('DashboardComponent', () => {
  ...
  it('should create', () => {
    ...
    // We must expect and flush the call from ngOnInit
  ...
  it('should load stats successfully on init', fakeAsync(() => {
    ...
    fixture.detectChanges();
    expect(component.isLoading()).toBe(true); // <-- Assert it's loading
    ...
    tick(); // <-- Advance the clock for the promise to resolve
    fixture.detectChanges(); // <-- ADD THIS to update the component state
